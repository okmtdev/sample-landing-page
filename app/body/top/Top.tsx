          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Hoge は素晴らしい品質の製品です。
                Next.jsはSEO対策に強いと聞きましたが、本当でしょうか？
                もちろんSSGとして利用するつもりです。 Google
                Analyticsは公式ライブラリで埋め込めるようになっているらしいです。
              </p>
              <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                <div className="relative pl-9">
                  ...
                  <dd className="inline">
                    :
                    HogeにはAIによる自動判定機能があります。高精度の自動判定は本製品のコア機能で、過去に1,000件を超える高評価レビューをいただきました。
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    : X（旧ツイッター）、Instagram、Facebookと連携可能です。
                    但し、それぞれのSNSでの連携対象は1アカウントのみとさせてください。
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    : 契約者様は専門のウェブサービスから Hoge
                    を管理していただけます。契約したタイミングからすぐにご利用可能です。
                  </dd>
                </div>
              </dl>
            </div>
